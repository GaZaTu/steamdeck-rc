...
// uint8_t getOrderedIndex(uint8_t index) {
//   return pgm_read_byte_near(channel_freq_ordered_index + index);
// }

// uint8_t getOrderedIndexFromIndex(uint8_t index) {
//   return pgm_read_byte_near(channel_index_to_ordered_index + index);
// }
